...
<form action="type_appeople_form_edit_db.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="file" name="img" id="img" class="form-control" />
			<img src="img_alumni/<?php echo $row['img'];?>" width="300px">
    </div>
    </div>
    ...
    <div class="col-1 col-sm-2 col-md-2" align="right"></div>
    <div class="col-2 col-sm-4 col-md-2">
      <input  name="moo" type="text" value="<?php echo $moo;?>" class="form-control" id="moo" placeholder="หมู่ที่" />
    </div>
    <div  class="col-2 col-sm-4 col-md-2" >
